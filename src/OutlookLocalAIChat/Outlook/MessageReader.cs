    ...
    public sealed class MessageReader
    {
            ...
            object context)
        {
            ...
            try
            {
                ...
                {
                    throw new InvalidOperationException(
                        "Select at least one email before using Send to AI365.");
                }

                if (count > MailboxWorkingSet.MaxMessages)
                {
                    throw new InvalidOperationException(
                        "Select no more than ten emails before using Send to AI365.");
                }
        ...
        internal static int CountRemoteImages(string htmlBody)
        {
            ...
            // image bytes, so AI365 can never read them. Embedded images
