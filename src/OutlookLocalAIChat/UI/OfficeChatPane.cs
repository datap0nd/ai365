/*
The AI365 pane for Excel and PowerPoint. It reuses the embedded chat
...
writes (AI365 Draft sheet, [AI365 draft] slides, unsent Outlook
    ...
    public sealed class OfficeChatPane : UserControl
    {
        ...
        private void PostMode()
        {
            ...
            PostToWeb(new Dictionary<string, object>
            {
                ...
                {
                    "text",
                    "Drafts stay unsaved and unsent - AI365 " +
